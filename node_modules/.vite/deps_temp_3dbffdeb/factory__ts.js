...
var require_is_plain_object = __commonJS({
  "../../node_modules/clone-deep/node_modules/is-plain-object/index.js"(exports, module) {
    "use strict";
  ...
  "../../node_modules/factory.ts/lib/sync.js"(exports) {
    ...
    var Factory = class _Factory {
      ...
      extend(def) {
        ...
        return new _Factory(builder, this.config);
      }
      combine(other) {
...
var require_pipeline = __commonJS({
  "../../node_modules/factory.ts/lib/pipeline.js"(exports) {
    ...
    var Pipeline = class _Pipeline {
      ...
      static start() {
        return new _Pipeline(Promise.resolve({}));
      }
      //add<T,U>(factory: Async.IFactory<T,U> | Async.FactoryFunc<T,U>, val: Parti (p:P) => Partial<T>)
      addValues(val) {
        return new _Pipeline(this.current.then((c) => __awaiter(this, void 0, void 0, function* () {
